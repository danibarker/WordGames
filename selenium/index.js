...
options.setChromeBinaryPath(process.env.CHROME_BINARY_PATH ||"C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe");
...
(async function run() {
    ...
    let serviceBuilder = new ServiceBuilder(process.env.CHROME_DRIVER_PATH || path.join(__dirname,'chromedriver.exe'));
